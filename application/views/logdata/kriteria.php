        ...
        <div class="col m-0 p-0 p-2" id="berita">
            ...
            <div class="col-md-12 m-0 p-2 pl-5 pr-5" id="body">
                ...
                <div class="col-md-12 m-0 p-2 pl-5 pr-5">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>logdata/kriteria/edit?id=<?php echo $a->id; ?>" class="btn btn-warning rounded-circle btn-aksi"><i
                    ...
                    <span class="font-weight-bold">*Total Bobot <?php echo $total; ?>/1</span>
                </div>
